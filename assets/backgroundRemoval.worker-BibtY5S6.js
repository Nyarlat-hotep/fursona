...
*)
*/
self.onmessage=async e=>{let{blob:t}=e.data;try{let e=await RO(t,{model:`isnet_fp16`,device:`gpu`,output:{format:`image/png`,quality:1},progress:(e,t,n)=>{self.postMessage({type:`progress`,key:e,current:t,total:n})}});self.postMessage({type:`done`,result:e})}catch(e){self.postMessage({type:`error`,message:e?.message||String(e)})}}})();